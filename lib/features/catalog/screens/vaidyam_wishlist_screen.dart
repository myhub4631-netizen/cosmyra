...
class _VaidyamWishlistScreenState extends ConsumerState<VaidyamWishlistScreen> {
  ...
  static final List<ProductModel> _demoWishlistProducts = [
    ProductModel(
      ...
      categoryId: 'Skincare',
      name: 'Kumkumadi Radiance Night Elixir',
      slug: 'kumkumadi-radiance-night-elixir',
      description: 'Handcrafted saffron & 26 Ayurvedic herbs for glowing skin',
      ingredients: 'Saffron, Chandan, Manjistha, Sesame Oil',
      freeFromClaims: const ['Paraben Free', 'Sulfate Free', '100% Organic'],
    ...
    ProductModel(
      ...
      brandId: 'brand-vaidyam',
      categoryId: 'Haircare',
      name: 'Bhringraj & Neem Hair Defense Oil',
      slug: 'bhringraj-neem-hair-defense-oil',
      description: 'Cold-pressed herb-infused oil for root strength & anti-dandruff',
      ingredients: 'Bhringraj, Neem, Amla, Coconut Oil',
      freeFromClaims: const ['Paraben Free', 'Mineral Oil Free'],
    ...
    ProductModel(
      ...
      name: 'Nalpamaradi Thailam Skin Brightening Oil',
      slug: 'nalpamaradi-thailam-skin-brightening-oil',
      description: 'Traditional turmeric & banyan bark body oil for natural glow',
      ingredients: 'Turmeric, Banyan Bark, Vetiver, Sesame Oil',
      freeFromClaims: const ['100% Natural'],
    ...
    ProductModel(
      ...
      brandId: 'brand-vaidyam',
      categoryId: 'Skincare',
      name: 'Shata Dhauta Ghrita 100-Times Washed Cream',
      slug: 'shata-dhauta-ghrita-cream',
      description: 'Pure A2 ghee whipped with cooling copper vessel water',
      ingredients: 'A2 Ghee, Rose Water, Saffron',
      freeFromClaims: const ['Cruelty Free'],
      imageUrls: const ['assets/images/facewash.jpg'],
      variants: const [
        ProductVariant(
          id: 'v4-1',
    ...
    ProductModel(
      ...
      brandId: 'brand-vaidyam',
      categoryId: 'Skincare',
      name: 'Pure Chandan & Rose Hydrating Face Wash',
      slug: 'chandan-rose-face-wash',
      description: 'Sulfate-free mild botanical cleanser for sensitive skin',
      ingredients: 'Sandalwood, Rose Petals, Aloe Vera',
      freeFromClaims: const ['Sulfate Free'],
      imageUrls: const ['assets/images/facewash.jpg'],
      variants: const [
        ProductVariant(
          id: 'v5-1',
    ...
    ProductModel(
      ...
      brandId: 'brand-vaidyam',
      categoryId: 'Haircare',
      name: 'Triphala & Hibiscus Revitalizing Shampoo',
      slug: 'triphala-hibiscus-shampoo',
      description: 'Amla, Reetha & Shikakai natural cleansing formulation',
      ingredients: 'Triphala, Hibiscus, Shikakai',
      freeFromClaims: const ['Paraben Free', 'Silicon Free'],
      imageUrls: const ['assets/images/shampoo.jpg'],
      variants: const [
        ProductVariant(
          id: 'v6-1',
