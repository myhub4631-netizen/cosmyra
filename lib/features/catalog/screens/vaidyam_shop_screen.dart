              ...
              children: [
                ...
                Row(
                  children: [
                    InkWell(
                      onTap: () => context.go('/'),
                      child: const Text('Home', style: TextStyle(fontSize: 13, color: Color(0xFF6B7280))),
                    ),
                    const Text('  >  ', style: TextStyle(fontSize: 13, color: Color(0xFF9CA3AF))),
                    const Text('Shop', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: Color(0xFF111827))),
                  ],
                ),
              ],
            ),
